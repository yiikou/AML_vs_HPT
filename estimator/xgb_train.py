...
def load_outer_parameter():
    ...
    parser.add_argument('--learning_rate', type=float, dest = 'learning_rate', help='silent')
    parser.add_argument('--subsample', type=float, dest = 'subsample', help='silent')
    parser.add_argument('--colsample_bytree', type=float, dest = 'colsample_bytree', help='silent')
    parser.add_argument('--gamma', type=int, dest = 'gamma', help='silent')
...
def load_hyperparameter(aargs):
    ...
    xgb_param = {'max_depth':aargs.max_depth, 'eta':aargs.eta, 'silent':aargs.silent
                 , 'learning_rate':aargs.learning_rate,'subsample':aargs.subsample
